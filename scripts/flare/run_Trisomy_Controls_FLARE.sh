...
raw_input="/data1/offitk/mardera1/chrombpnet_flare/output/summarize/1kg_rare.Trisomy_Controls.txt"

# Desired output files:
processed_input="${repo_dir}/data/processed/1kg_rare.Trisomy_Controls.FLARE.txt"
model_dir="${repo_dir}/new_models/Trisomy_Controls"
pred_file="${repo_dir}/predictions/1kg_rare.Trisomy_Controls.FLARE.pred.txt"
perf_file="${repo_dir}/predictions/1kg_rare.Trisomy_Controls.FLARE.performance.txt"
