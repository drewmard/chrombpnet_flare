...
# Keep these values synchronized with 1_score_variants_devblood_v2.sh.
...
HEADDIR=/data1/offitk/mardera1/data/cvejic_blood_multiome/models
peaks_dir=$HEADDIR/resources/peaks
