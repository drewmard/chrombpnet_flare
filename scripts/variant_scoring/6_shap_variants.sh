...
SET=myb_motif_snps
variants=/data1/offitk/mardera1/chrombpnet_flare/variant_lists/ahi1_test.tsv
SET=ahi1_test
variants=/data1/offitk/mardera1/data/hg38_refs/variants.scoring_file.tsv
SET=ahi1_mhe
clust=/data1/offitk/mardera1/data/Trisomy/Control/chrombpnet_models/K562_bias/HSCs
fld=0
